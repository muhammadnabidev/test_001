...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.achievement-card, .club-card, .contact-item');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const cards = document.querySelectorAll('.achievement-card, .club-card');
    cards.forEach(card => {
...
const modalExitStyles = document.createElement('style');
modalExitStyles.textContent = `
    @keyframes fadeOut {
        from { opacity: 1; }
        to { opacity: 0; }
    }
...
`;
document.head.appendChild(modalExitStyles);
